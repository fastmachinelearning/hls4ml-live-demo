...
set_property PACKAGE_PIN T19 [get_ports {hdmi_in_hpd_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_in_hpd_0[0]}]
set_property PACKAGE_PIN R19 [get_ports {hdmi_out_hpd_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_out_hpd_0[0]}]

set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_dcc_scl_io]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_dcc_sda_io]
set_property PACKAGE_PIN U14 [get_ports hdmi_in_dcc_scl_io]
set_property PACKAGE_PIN U15 [get_ports hdmi_in_dcc_sda_io]
