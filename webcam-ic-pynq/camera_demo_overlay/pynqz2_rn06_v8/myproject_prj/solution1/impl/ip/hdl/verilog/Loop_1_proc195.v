...
wire   [4:0] select_ln356_10_fu_582_p3;
wire   [4:0] select_ln356_9_fu_574_p3;
...
wire   [23:0] select_ln356_11_fu_624_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln17_fu_188_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (icmp_ln20_fu_200_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (icmp_ln20_fu_200_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln17_fu_188_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_0_i_reg_162 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((icmp_ln17_fu_188_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (1'b1 == ap_CS_fsm_state3)))) begin
        grp_fu_174_ce = 1'b1;
    end else begin
        grp_fu_174_ce = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln20_fu_200_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((icmp_ln20_fu_200_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if ((~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (icmp_ln20_fu_200_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~(((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0))) & (icmp_ln20_fu_200_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign and_ln356_2_fu_662_p2 = (select_ln356_11_fu_624_p3 & and_ln356_fu_644_p2);
...
always @ (*) begin
    ap_block_state3 = (((icmp_ln20_fu_200_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)) | ((icmp_ln20_fu_200_p2 == 1'd1) & (io_acc_block_signal_op40 == 1'b0)));
end
...
assign empty_570_fu_544_p2 = (shl_ln_fu_536_p3 | 5'd7);

assign exp_tmp_V_fu_275_p4 = {{ireg_V_fu_259_p1[62:52]}};

assign i_fu_194_p2 = (i_0_i_reg_151 + 11'd1);

assign icmp_ln17_fu_188_p2 = ((i_0_i_reg_151 == 11'd1024) ? 1'b1 : 1'b0);

assign icmp_ln20_fu_200_p2 = ((j_0_i_reg_162 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln356_fu_550_p2 = ((shl_ln_fu_536_p3 > empty_570_fu_544_p2) ? 1'b1 : 1'b0);
...
assign icmp_ln603_fu_388_p2 = ((tmp_392_fu_378_p4 == 9'd0) ? 1'b1 : 1'b0);
...
assign select_ln356_10_fu_582_p3 = ((icmp_ln356_fu_550_p2[0:0] === 1'b1) ? sub_ln356_fu_560_p2 : shl_ln_fu_536_p3);

assign select_ln356_11_fu_624_p3 = ((icmp_ln356_fu_550_p2[0:0] === 1'b1) ? tmp_394_fu_614_p4 : shl_ln356_fu_608_p2);

assign select_ln356_9_fu_574_p3 = ((icmp_ln356_fu_550_p2[0:0] === 1'b1) ? empty_570_fu_544_p2 : shl_ln_fu_536_p3);

assign select_ln356_fu_566_p3 = ((icmp_ln356_fu_550_p2[0:0] === 1'b1) ? shl_ln_fu_536_p3 : empty_570_fu_544_p2);

assign select_ln588_fu_418_p3 = ((tmp_393_fu_410_p3[0:0] === 1'b1) ? 8'd255 : 8'd0);
...
assign tmp_392_fu_378_p4 = {{sh_amt_fu_359_p3[11:3]}};

assign tmp_393_fu_410_p3 = bitcast_ln696_fu_407_p1[32'd31];
...
always @ (shl_ln356_fu_608_p2) begin
    for (ap_tvar_int_0 = 24 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 23 - 0) begin
            tmp_394_fu_614_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_394_fu_614_p4[ap_tvar_int_0] = shl_ln356_fu_608_p2[23 - ap_tvar_int_0];
        end
    end
end
...
assign zext_ln356_1_fu_596_p1 = select_ln356_10_fu_582_p3;

assign zext_ln356_2_fu_600_p1 = select_ln356_9_fu_574_p3;
