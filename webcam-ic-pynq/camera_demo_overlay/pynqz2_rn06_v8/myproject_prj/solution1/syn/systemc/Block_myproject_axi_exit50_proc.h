...
struct Block_myproject_axi_exit50_proc : public sc_module {
    ...
    sc_signal< sc_lv<14> > tmp_data_V_0_preg;
    sc_signal< sc_lv<14> > tmp_data_V_1_preg;
    sc_signal< sc_lv<14> > tmp_data_V_2_preg;
    sc_signal< sc_lv<14> > tmp_data_V_3_preg;
    sc_signal< sc_lv<14> > tmp_data_V_4_preg;
    sc_signal< sc_lv<14> > tmp_data_V_5_preg;
    sc_signal< sc_lv<14> > tmp_data_V_6_preg;
    sc_signal< sc_lv<14> > tmp_data_V_7_preg;
    sc_signal< sc_lv<14> > tmp_data_V_8_preg;
    sc_signal< sc_lv<14> > tmp_data_V_9_preg;
