...
module shift_line_buffer_array_ap_fixed_32u_config7_s_line_buffehbi_core (
    clk,
    ce,
    din,
    addr,
...
module shift_line_buffer_array_ap_fixed_32u_config7_s_line_buffehbi (
    clk,
    reset,
    address0,
    ce0,
...
shift_line_buffer_array_ap_fixed_32u_config7_s_line_buffehbi_core #(
