...
architecture behav of Block_myproject_axi_exit50_proc is 
    ...
    signal tmp_data_V_0_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_1_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_2_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_3_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_4_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_5_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_6_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_7_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_8_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal tmp_data_V_9_preg : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_0_preg <= ap_const_lv14_0;
            else
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_1_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_2_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_3_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_4_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_5_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_6_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_7_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_8_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                tmp_data_V_9_preg <= ap_const_lv14_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
